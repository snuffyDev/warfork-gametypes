...
bool GT_Command( Client @client, const String &cmdString, const String &argsString, int argc )
{
    ...
    {
        return spinGTRound.GT_CallvoteValidate( client, voteName, argsString );
    }
    // example of callvote
    else if ( cmdString == "callvotepassed" )
    {
        return spinGTRound.GT_CallvotePassed( client, voteName, argsString );
    }
...
void GT_InitGametype()
{
    ...
    if ( !G_FileExists( "configs/server/gametypes/" + gametype.name + ".cfg" ) )
    {
        ...
        config = "// '" + gametype.title + "' gametype configuration file\n"
                 ...
                 + "set spingt_direction \"1\" // 0 - left | 1 - right\n"
                 + "\n// classes settings\n"
    ...
    for ( int i = 0; i < maxClients; i++ )
    {
        ...
        Players[i].direction = spingt_direction.integer;
    }
