...
void DM_playerKilled( Entity @target, Entity @attacker, Entity @inflictor )
{
    ...
    if ( @attacker != null && @attacker.client != null && @target != null && @target.client != null )
    {
...
void GT_ScoreEvent( Client @client, const String &in score_event, const String &in args )
{
    if ( score_event == "dmg" )
    {
...

        {
            ...
            {
                if ( attacker.playerNum == G_GetEntity( 0 ).playerNum )
                {
                    return;
                }
...
void GT_InitGametype()
{
    ...
    G_RegisterCallvote( "vamp_health_max", "250 to 1000", "integer", "Sets the maximum health in VampFFAA" );

    G_RegisterCallvote( "vamp_health_start", "1 to 500", "integer", "Sets the starting health in VampFFAA" );

    G_RegisterCallvote( "vamp_percent", "1 to 100", "integer", "Sets the percentage of given damage that is received as health in VampFFAA" );
