...
const int CA_LAST_MAN_STANDING_BONUS = 0; // 0 points for each fragrunawa
...
class cCARound
{
    ...
    void playerKilled( Entity @target, Entity @attacker, Entity @inflictor )
    {
        ...
        target.client.execGameCommand( "+left" );
    }
}
...
{
    gametype.title = "Spin Clan Arena";
    ...
    if ( !G_FileExists( "configs/server/gametypes/" + gametype.name + ".cfg" ) )
    {
        ...
        config = "// '" + gametype.title + "' gametype configuration file\n"
                 + "// This configexecGameCommand will be executed each time the gametype is started\n"
                 + "\n\n// map rotation\n"
                 ...
                 + "set spinffaa_speed \"2\" // 1 - slowest | 5 - fastest\n"
                 + "set spinffaa_modifier \"0\" // 0 - off | 1 - on\n"
                 + "\n// classes settings\n"
