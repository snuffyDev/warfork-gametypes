...
bool GT_Command( Client @client, const String &cmdString, const String &argsString, int argc )
{
    ...
    else if ( cmdString == "opt_out_motion" )
    {
        if ( argsString == "1" )
        {
            partyGt.motionSickOptIn( client );
            G_PrintMsg( client.getEnt(), "You have opted in to motion blur.\n" );
            return true;
        }
        else if ( argsString == "0" )
        {
            partyGt.motionSickOptOut( client );
            G_PrintMsg( client.getEnt(), "You have opted out of motion blur.\n" );
            return true;
        }
    }
    return false;
...
void GT_ThinkRules()
{
    ...
    for ( int i = 0; i < maxClients; i++ )
    {
        ...
        if (@client == null || G_GetEntity( i ).isGhosting() )
        continue;
